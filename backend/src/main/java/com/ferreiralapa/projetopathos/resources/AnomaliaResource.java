...
public class AnomaliaResource {
	...
	@GetMapping
	public ResponseEntity<Page<AnomaliaDTO>> findAll(
			@RequestParam(value = "page", defaultValue = "0") Integer page,
			@RequestParam(value = "linesPerPage", defaultValue = "10") Integer linesPerPage, 
			@RequestParam(value = "direction", defaultValue = "DESC") String direction,
			@RequestParam(value = "orderBy", defaultValue = "consequente") String orderBy
			) {		
		PageRequest pageRequest = PageRequest.of(page, linesPerPage, Direction.valueOf(direction), orderBy);	
		Page<AnomaliaDTO> list = AnomaliaService.findAllPaged(pageRequest);
	...
	@PostMapping
	public ResponseEntity<AnomaliaDTO> insert(@RequestBody AnomaliaDTO dto) {
	...
	@PutMapping(value = "/{id}")
	public ResponseEntity<AnomaliaDTO> update(@PathVariable Long id, @RequestBody AnomaliaDTO dto) {

...
INSERT INTO tb_edificio (localizacao, tipologia, name, utilizacao, arquitetura, piso, fracao, img_url, date, created_At) VALUES ('Covilhã', 'Prédio', 'Serradas', 'Habitação', 'Moderna', 70, '5B', 'https://www.ferreiralapa.com/wp-content/uploads/2021/09/3-1-1024x768.jpg', TIMESTAMP WITH TIME ZONE '2022-04-14T10:00:00Z', NOW());
